...
modified afterwards to fit the needs of the {Design documentation}[https://github.com/peterkmurphy/toytracks/blob/master/design.md]. While Prelang has been described as, since
While Prelang has been described as "abandonware", it was easier to use than 
{Rails Composer}[https://github.com/RailsApps/rails-composer]. Composer (as of January 2018), consistently produces buggy-does-not-start
code, especially when {Devise}[https://github.com/plataformatec/devise] is specified to be part of the package. Version conflicts,
missing variables, it was all happening!  
